...
lengthNormalisedResiduals <- residuals / length

standardDevP1 = sqrt(kmercov*(1+bias))
standardDevP2 = sqrt(2*kmercov*(1+bias))

print(sum(abs(lengthNormalisedResiduals[(kmercov - standardDevP1): (kmercov + standardDevP1)])))
print(sum(abs(lengthNormalisedResiduals[(2*kmercov - standardDevP2):( 2*kmercov + standardDevP2)])))